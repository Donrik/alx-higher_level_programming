...
OBOBOB        r = Rectangle(5, 7, 7, 5, 1)
OBOBOB        self.assertEqual(5, r.y)

OBOBOB    def test_y_setter(self):
        r = Rectangle(5, 7, 7, 5, 1)
        r.y = 10
...
OBOBOB            Rectangle(True, 2)
    ...
    def test_bytearray_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
OBOBOB            Rectangle(bytearray(b'abcdefg'), 2)
...
OBOBOB
    def test_three_args(self):
        r1 = Rectangle(2, 2, 4)
OBOBOB        r2 = Rectangle(4, 4, 2)
        self.assertEqual(r1.id, r2.id - 1)

    def test_four_args(self):
        r1 = Rectangle(1, 2, 3, 4)
OBOBOB        r2 = Rectangle(4, 3, 2, 1)
        self.assertEqual(r1.id, r2.id - 1)

OBOBOB    def test_five_args(self):
        self.assertEqual(7, Rectangle(10, 2, 0, 0, 7).id)
